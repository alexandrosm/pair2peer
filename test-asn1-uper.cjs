...
// Load the ASN.1 UPER codec
const codecCode = fs.readFileSync('asn1-uper-codec.js', 'utf8');
const { encodeWebRTCData, decodeWebRTCData } = eval(`
    ${codecCode}
    ({ encodeWebRTCData, decodeWebRTCData })
`);
